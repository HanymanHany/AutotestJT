...
public class TestMailRU extends EnvContainer {
    ...
    // WHEN we enter an empty login THEN an error is displayed in the login field
    @Test( enabled = true)
    ...
    // WHEN we enter an empty password THEN an error is displayed in the password field
    @Test( enabled = true)
